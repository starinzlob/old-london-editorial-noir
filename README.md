...
### 丝网印刷海报 / Screen-printed posters

| 巨型字窗 / Monumental type windows |  |  |
| --- | --- | --- |
| ![福尔摩斯主题巨型字窗丝网印刷海报 / Sherlock monumental-type screen-print poster](examples/posters/01-sherlock.jpg) | ![暗影蛛网主题巨型字窗丝网印刷海报 / Night Web monumental-type screen-print poster](examples/posters/02-night-web.jpg) | ![神奇动物主题巨型字窗丝网印刷海报 / Fantastic Beasts monumental-type screen-print poster](examples/posters/03-fantastic-beasts.jpg) |
| 福尔摩斯 / Sherlock | 暗影蛛网 / Night Web | 神奇动物 / Fantastic Beasts |

| 实心标题 / Solid editorial headlines |  |  |
| --- | --- | --- |
| ![雨夜伦敦实心标题丝网印刷海报 / Old London solid-headline screen-print poster](examples/posters/04-old-london.jpg) | ![伦敦铁路实心标题丝网印刷海报 / Print the Fog railway screen-print poster](examples/posters/05-print-the-fog.jpg) | ![打字机实心标题丝网印刷海报 / Install the Atmosphere typewriter screen-print poster](examples/posters/06-install-the-atmosphere.jpg) |
| 雨夜伦敦 / Old London | 雾中铁路 / Print the Fog | 安装氛围 / Install the Atmosphere |
...
```text
参考这张海报的粗网点和套印质感，但不要继承它的题材、配色、
线框地球、坐标或准星。用巨型字窗做一张福尔摩斯主题 9:16 海报。
```
...
示例图片由 OpenAI 图像生成工具制作，艺术指导来自本 Skill。场景示例不承载精确正文；海报示例只使用少量短英文测试生成排版。正式制作中的长标题、双语文案、字幕和正文仍应尽量保持可编辑。
...
```text
Use this poster only for coarse halftone and misregistered print texture.
Do not inherit its subject, palette, wireframe globe, coordinates, or crosshairs.
Create a 9:16 Sherlock Holmes poster with monumental type windows.
```
...
The example images were generated with OpenAI image generation using art direction produced from this Skill. Scene examples carry no exact body copy; poster examples use only a few short English lines to test generated typography. Long titles, bilingual copy, subtitles, and production body text should remain editable whenever possible.
